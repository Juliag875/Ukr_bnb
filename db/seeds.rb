...
puts "⭐Seeding Rentals..."
 ...
 h2 = Rental.create(
  client_id: Client.all.sample.id,
  host_id: Host.all.sample.id,
  name: "Modern Studio w/Queen size bed", 
  address: "Philadelphia, Pennsylvania, United States",
  image: "https://a0.muscache.com/im/pictures/miso/Hosting-54163912/original/fbcbc555-eb70-46bb-9a06-844b56235681.jpeg?im_w=960",
 ...
 h3 = Rental.create(
  client_id: Client.all.sample.id,
  host_id: Host.all.sample.id,
  name: "Brand New Private Apartment",
  address: "Brooklyn, New York, United States",
 ...
 h8 = Rental.create(
  client_id: Client.all.sample.id,
  host_id: Host.all.sample.id,
  name: "Master Bedroom on Canal | Amsterdam Center",
 ...
 h10 = Rental.create(
   client_id: Client.all.sample.id,
   host_id: Host.all.sample.id,
  name: "Panoramic City View Apartment",
 ...
 h11 = Rental.create(
   client_id: Client.all.sample.id,
   host_id: Host.all.sample.id,
  name: "Spacious Bungalow with Parking", 
 ...
 h16 = Rental.create(
  ...
  image: "https://a0.muscache.com/im/pictures/eac0468a-ff1c-4b0d-9567-8c1be3954bf7.jpg?im_w=960",
 ...
 h19 = Rental.create(
   client_id: Client.all.sample.id,
   host_id: Host.all.sample.id,
  name: "Upper Floor in Private House", 
